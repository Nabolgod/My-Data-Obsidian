...
public:
	...
	virtual void speak(){ // указание что метод виртуальный, его нельзя вызвать у базового класса
		cout << "i am speaking" << endl;
	}
	
	virtual void speak() = 0; // виртаульная функция, (абстрактный метод) и класс теперь тоже абстрактный. Он не имеет своих объектов.
	
}

%% Класс состоящий только из виртуальных функций называется интерфейсом. Он задает правила игры. %%
